...
public:
   ...
   */
  DronPose() : _Wsp_m(0, 0, 0), _Angle_deg(0) {}
   ...
   *                    wyrażonej w metrach,
   */
  void SetPos_m(const Wektor3D &rWsp_m) { _Wsp_m = rWsp_m; }
  /*!
   ...
   */
  void SetAngle_deg(double angle_deg) { _Angle_deg = angle_deg; }
  ...
  */
   ...
   */
  double GetAngle_deg(double angle_deg) { return _Angle_deg; }
};
